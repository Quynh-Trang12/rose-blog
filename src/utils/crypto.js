 ...
 * The Web Crypto API's subtle.digest method performs the hash
...
export const hashPassword = async (password) => {
  // TextEncoder converts the string to a Uint8Array of UTF-8 bytes.
  const encoder = new TextEncoder()
  const data = encoder.encode(password)

  // digest() returns an ArrayBuffer containing the raw SHA-256 hash.
